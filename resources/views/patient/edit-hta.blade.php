        ...
        <div class="col-sm-8 col-sm-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="/update-hta" id="form-bp" data-toggle="validator">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('SYS') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <input id="sys" type="number" class="form-control" name="SYS" max="350" value="{{$blood_pressure->SYS}}" required >
                        ...
                        <div class="form-group{{ $errors->has('DIS') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <input id="dis" type="number" class="form-control" name="DIS" max="350" value="{{ $blood_pressure->DIS}}" required>
                                <div class="help-block with-errors"></div>
                                @if ($errors->has('DIS'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('pulso') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                                <input id="pulso" type="number" class="form-control" name="pulso" max="350" value="{{ $blood_pressure->pulso}}" required>
                                <div class="help-block with-errors"></div>
                                @if ($errors->has('pulso'))
                                    <span class="help-block">
                        ...
                        <input id="id" type="hidden" name="id" value="{{ $blood_pressure->id }}">
