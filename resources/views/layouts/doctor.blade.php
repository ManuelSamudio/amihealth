        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <!--<li>
                        <a href="/panel"><i class="fa fa-dashboard fa-fw" class="active"></i> Dashboard</a>
                    </li>-->
                    <li>
                        <a href="#"><i class="fa fa-user-md fa-fw"></i> Pacientes<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="/show-patients"><i class="fa fa-list-ul fa-fw"></i>Lista de Pacientes</a>
                            </li>
                            <li>
                                <a href="/add-patient"><i class="fa fa-plus-circle fa-fw"></i>Nuevo Paciente</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
