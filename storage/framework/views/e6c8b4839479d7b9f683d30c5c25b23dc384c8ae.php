                    ...
                    <?php $__currentLoopData = $waists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $waist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <ul class="event-list">
                            <li>
                                ...
                                <div class="social">
                                    <ul>
                                        <li class="facebook" style="width:33%;"><a href="edit-cintura/<?php echo e($waist->id); ?>"><span class="fa fa-pencil"></span></a></li>
                                        <li class="twitter" style="width:34%;"><a href="" data-toggle="modal" data-target="#myModal"><span class="fa fa-info"></span></a></li>
                                        <li class="google-plus" style="width:33%;"><a href="delete-cintura/<?php echo e($waist->id); ?>"><span class="fa fa-trash"></span></a></li>
                                    </ul>
                                </div>
                            </li>
