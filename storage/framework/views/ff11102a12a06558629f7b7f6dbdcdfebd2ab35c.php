        ...
        <div class="col-sm-8 col-sm-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="/store_hta" id="form-bp" data-toggle="validator">
                        ...
                        <div class="form-group<?php echo e($errors->has('SYS') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-4">
                                <input id="sys" type="number" class="form-control" name="SYS" max="350" value="<?php echo e(old('SYS')); ?>" required>
