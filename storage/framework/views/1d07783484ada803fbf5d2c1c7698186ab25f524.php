          ...
          <div class="col-sm-8 col-sm-offset-2">
              <div class="panel panel-default">
                  ...
                  <div class="panel-body">
                      <form class="form-horizontal" role="form" method="POST" action="store-weight" data-toggle="validator">
                          ...
                          <div class="form-group<?php echo e($errors->has('peso') ? ' has-error' : ''); ?>">
                              ...
                              <div class="col-md-4">
                                  <input id="peso" type="number" step="0.1"class="form-control" name="peso" value="<?php echo e(old('peso')); ?>" required autofocus>
