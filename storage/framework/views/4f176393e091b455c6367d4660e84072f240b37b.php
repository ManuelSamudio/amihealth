...
<head>
    ...
    <!-- DataTables CSS -->
    <link href="<?php echo e(asset ('/template/datatables-plugins/dataTables.bootstrap.css')); ?>" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="<?php echo e(asset('/template/datatables-responsive/dataTables.responsive.css')); ?>" rel="stylesheet">
    ...
    <!-- Custom Fonts -->
    <link  href="<?php echo e(asset('/template/font-awesome/css/font-awesome.min.css')); ?>" rel="stylesheet"/>
    ...
    <script src="<?php echo e(asset('/template/datatables-plugins/dataTables.bootstrap.min.js')); ?> "></script>
    <script src="<?php echo e(asset('/template/datatables-responsive/dataTables.responsive.js')); ?> "></script>
