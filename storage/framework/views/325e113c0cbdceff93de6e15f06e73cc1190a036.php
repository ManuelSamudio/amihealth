            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="store-temperature" data-toggle="validator">
                        ...
                        <div class="form-group<?php echo e($errors->has('temperature') ? ' has-error' : ''); ?>">
                            <label for="peso" class="col-md-4 control-label">Temperatura (Cº)</label>

                            <div class="col-md-4">
                                <input id="peso" type="number" step="0.1"class="form-control" name="temperatura" value="<?php echo e(old('temperatura')); ?>" required autofocus>
                                <div class="help-block with-errors"></div>
                                <?php if($errors->has('temperature')): ?>
                                    <span class="help-block">
                                          <strong><?php echo e($errors->first('temperature')); ?></strong>
                                      </span>
                                <?php endif; ?>
                            </div>
                        </div>
