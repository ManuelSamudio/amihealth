                 ...
                 <?php $__currentLoopData = $blood_pressures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blood_pressure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <ul class="event-list">
                         <li>
                             ...
                             <div class="social">
                                 <ul>
                                     <li class="facebook" style="width:33%;"><a href="edit-hta/<?php echo e($blood_pressure->id); ?>"><span class="fa fa-pencil"></span></a></li>
                                     <li class="twitter" style="width:34%;"><a href="" data-toggle="modal" data-target="#myModal"><span class="fa fa-info"></span></a></li>
                                     <li class="google-plus" style="width:33%;"><a href="delete-hta/<?php echo e($blood_pressure->id); ?>"><span class="fa fa-trash"></span></a></li>
                                 </ul>
                             </div>
                         </li>
